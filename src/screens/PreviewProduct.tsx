...
export function PreviewProduct() {
  ...
  return (
    <>
      <VStack justifyContent="flex-start" alignItems="center" px={4} pt={20} pb={6} bg="blue.500">
      ...
      >
        ...
        <VStack flex={1} mt={5} px={6}>
          ...
          <VStack mb={5}>
            <HStack>
              <Box
                bg={ product.isNew === "new" ? 'blue.500' : 'gray.300' } 
                rounded="full"
                px={4}
              ...
              >
                {product.isNew === "new"
                  ? <Text fontFamily="heading" color="gray.100">NOVO</Text> 
                  : <Text fontFamily="heading" color="gray.700">USADO</Text>
                }
          ...
          <VStack>
            ...
            <VStack>
              <Text color="gray.600" fontWeight="bold" mb={3}>Meios de pagamento:</Text>
